...
"[project]/scraper-app/src/app/api/extractor/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$scraper$2d$app$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/scraper-app/node_modules/next/server.js [app-route] (ecmascript)");
;
...
async function fetchPage(eventVariable, pageNumber, pageSize = 90) {
...
function extractFitEmails(data) {
    const results = [];
    if (!Array.isArray(data)) return [];
    for (const item of data){
        let website = "";
        if (item.empresaRedesSociales && Array.isArray(item.empresaRedesSociales)) {
            const webObj = item.empresaRedesSociales.find((red)=>red.redSocial?.id === 1 && red.link);
    ...
    try {
        ...
        if (source === "fit") {
            ...
            if (!url || !url.includes("messefrankfurt.com")) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$scraper$2d$app$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    success: false,
                    error: "Por favor incluye un enlace válido de Messe Frankfurt."
                }, {
                    status: 400
                });
            }
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$scraper$2d$app$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: `Oh no, algo salió mal internamente: ${e.message}`
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7ac34a4f._.js.map